#
# Be sure to run `pod lib lint AXWebview.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AXWebview'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AXWebview.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'AXWebview/Classes/**/*'
  
  # s.resource_bundles = {
  #   'AXWebview' => ['AXWebview/Assets/*.png']
  # }
